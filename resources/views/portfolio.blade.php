            ...
            <div class="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-slate-200/70 p-8">
                    ...
                    <form class="space-y-6">
                        <!-- Name Field -->
                        <div>
                            <label for="name" class="block text-sm font-medium text-[#0b1530] mb-2">Full Name</label>
                        ...
                        <!-- Email Field -->
                        <div>
                            <label for="email" class="block text-sm font-medium text-[#0b1530] mb-2">Email Address</label>
                        ...
                        <!-- Requirements Field -->
                        <div>
                            <label for="requirements" class="block text-sm font-medium text-[#0b1530] mb-2">Project Requirements</label>
                ...
                <div class="space-y-8">
                    ...
                    <div class="space-y-6">
                        <!-- WhatsApp -->
                        <div class="flex items-center gap-4 p-4 bg-white rounded-xl shadow-sm border border-slate-200/70">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-slate-200/70 p-6">
                        ...
                        <div class="flex items-center gap-4">
                            <!-- Instagram -->
                            <a href="#" class="flex items-center gap-3 p-3 rounded-lg bg-gradient-to-r from-pink-500 to-purple-600 text-white hover:shadow-md transition-shadow group">
                            ...
                            <!-- Facebook -->
                            <a href="#" class="flex items-center gap-3 p-3 rounded-lg bg-blue-600 text-white hover:bg-blue-700 hover:shadow-md transition-all group">
