    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <h1 class="mb-1 font-medium">Ayo mulai</h1>
                <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">Laravel memiliki ekosistem yang sangat kaya. <br>Kami
                    sarankan mulai dari beberapa hal berikut.</p>
